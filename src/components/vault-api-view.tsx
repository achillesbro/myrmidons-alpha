  ...
  if (onchainLoading) {
    return (
      <div className="space-y-3">
        ...
        {/* First row: Key Metrics (4 columns) skeleton */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-3 animate-pulse">
              <div className="h-3 bg-[#E1E1D6] rounded w-12 mb-2"></div>
              <div className="h-7 bg-[#E1E1D6] rounded w-20"></div>
            </div>
          ))}
        </div>
        
        {/* Second row: Left (1/3) Current Position + Deposit/Withdraw, Right (2/3) Chart skeleton */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          {/* Left column: Current Position + Deposit/Withdraw skeleton - 1/3 width */}
          <div className="lg:col-span-1 space-y-3">
            ...
            <div className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-3 animate-pulse">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <div className="h-3 bg-[#E1E1D6] rounded w-12 mb-2"></div>
                  <div className="h-8 bg-[#E1E1D6] rounded w-20"></div>
                </div>
                <div>
                  <div className="h-3 bg-[#E1E1D6] rounded w-16 mb-2"></div>
                  <div className="h-8 bg-[#E1E1D6] rounded w-20"></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-3 animate-pulse">
              <div className="flex gap-2 mb-3 p-1 bg-gray-100 rounded-lg">
                <div className="flex-[2] h-8 bg-[#E1E1D6] rounded-md"></div>
                <div className="flex-1 h-8 bg-[#E1E1D6] rounded-md"></div>
              </div>
              <div className="space-y-2">
                <div className="h-12 bg-[#E1E1D6] rounded-lg"></div>
                <div className="h-10 bg-[#E1E1D6] rounded-lg"></div>
                <div className="h-10 bg-[#E1E1D6] rounded-lg"></div>
              </div>
            </div>
          </div>
          
          {/* Right column: Chart skeleton - 2/3 width */}
            ...
            <div className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-5 animate-pulse">
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-8 bg-[#E1E1D6] rounded w-24"></div>
                </div>
              </div>
              <div className="h-[400px] bg-[#E1E1D6] rounded"></div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-3 h-full animate-pulse">
              ...
              <div className="h-3 bg-[#E1E1D6] rounded w-full mb-3"></div>
        ...
        <div className="bg-[#FFFFF5] border border-[#E5E2D6] rounded-lg p-4 animate-pulse">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="h-4 bg-[#E1E1D6] rounded w-24 mb-2"></div>
                <div className="h-3 bg-[#E1E1D6] rounded w-40"></div>
              </div>
              <div className="h-6 bg-[#E1E1D6] rounded w-16"></div>
            </div>
            <div className="h-px bg-[#E5E2D6]"></div>
            <div className="flex items-center justify-between">
              <div>
                <div className="h-4 bg-[#E1E1D6] rounded w-32 mb-2"></div>
                <div className="h-3 bg-[#E1E1D6] rounded w-36"></div>
              </div>
              <div className="h-6 bg-[#E1E1D6] rounded w-20"></div>
            </div>
          </div>
        </div>
      </div>
